---
url: "https://my.gov.sa/ar/services/18653"
title: "التحقق من المؤهلات الجامعية (مؤهل) | GOV.SA"
---
...
خدمة إلكترونية تقدمها وزارة التعليم تتيح للمستخدم إمكانية الاستعلام إلكترونيا عن المؤهلات التعليمية الأكاديمية التي حصل عليها، مع توفير خيار تقديم طلب لتصحيح البيانات في حال وجود أخطاء بطريقة بسيطة وسهلة.
كما تمكن المستفيد من تقديم طلب لإضافة مؤهل جديد في حال عدم ظهوره، وتعتمد هذه الخدمة على مستودع البيانات المتكامل المرتبط بجميع الجهات المصدرة للشهادات التعليمية دون الحاجة لزيارة مقر الوزارة
...
[ابدأ الخدمة](https://moe.gov.sa/ar/knowledgecenter/eservices/pages/moahal.aspx)
...
-  الدخول على بوابة جامعة

- اختر ""خدمة مؤهل"" الموجودة ضمن الخدمات أسفل الصفحة.

- ادخل اسم المستخدم وكلمة المرور أو الدخول عبر النفاذ الموحد ( أبشر).

-  يمكنك الآن الإستفادة من الخدمة.

- عرض المؤهلات:

-  بعد الدخول على الخدمة اختر "مؤهلاتي" من القائمة الفرعية.

- ستظهر لك نافذة تحتوي على مؤهلاتك.

- وفي حال لم يتم عرض المؤهلات العلمية ، تتيج الخدمة  رفع طلب إضافة مؤهل وإكمال جميع البيانات والمستندات المطلوبة وإرسال الطلب الى الجهة المانحة للمؤهل. وايضا يمكن رفع طلب تعديل مؤهل في حالة كانت بيانات المؤهل المعروضة غير صحيحة.

- تسجيل جهة:

-  بعد الدخول على الخدمة اختر "تسجيل جهة" من القائمة الفرعية.

-  إكمال البيانات المطلوبة.

- إرفاق المستندات المطلوبة.

-  بعد تعبئة البيانات وإرفاق الملفات قم بالنقر على ايقونة "إرسال".

- تم إرسال الطلب وبإنتظار الموافقة عليه من الوزارة.


- التسجيل للأفراد: لا يوجد شروط

- التسجيل كجهة:

-  خطاب تفويض ممثل الجهة.

- صورة هوية لممثل الجهة.

-  سجل تجاري (للقطاع الخاص فقط)


- لا يوجد مستندات مطلوب لهذه الخدمة

![الأفراد  , ,القطاع الحكومي  , ,القطاع الخاص  , ,طالب ](https://my.gov.sa/_next/static/media/icon_serv_8.1d636da7.svg)

الأفراد , القطاع الحكومي , القطاع الخاص , طالب
...
تحميل دليل المستخدم](https://www.moe.gov.sa/ar/knowledgecenter/eservices/Documents/Moahal.pdf)
...
تاريخ آخر تحديث لمحتوى الصفحة : 29/05/2025 بتمام الساعة 09:32 مساء بتوقيت المملكة العربية السعودية
