---
url: "https://my.gov.sa/ar/services/19553"
title: "التحقق من طلب التنفيذ | GOV.SA"
---
...
خدمة الكترونية تتيح للمستفيد التحقق والاستعلام عن طلب تنفيذ، واستعراض جميع تفاصيل القرارات، والإجراءات، والحركات المالية وفق آخر تحديث تم على الطلب
...
[ابدأ الخدمة](https://www.moj.gov.sa/ar/eServices/Pages/ServiceDetailsNew.aspx?itemId=426)
...
#شرح\_خدمة\_عدلية \| خدمة التحقق من طلب التنفيذ عبر منصة ناجز Najiz.Sa  - YouTube
...
[#شرح\_خدمة\_عدلية \| خدمة التحقق من طلب التنفيذ عبر منصة ناجز Najiz.Sa](https://www.youtube.com/watch?v=Kgbh2LffQGs)
...
[Watch on YouTube](https://www.youtube.com/watch?v=Kgbh2LffQGs "Watch on YouTube")

- الدخول على بوابة ناجز
- اختيار جميع الخدمات الإلكترونية
- اختيار باقة (التنفيذ)
- الدخول إلى خدمة (التحقق من طلب تنفيذ)
- الضغط على أيقونة (تقديم طلب جديد)
- إدخال (رقم الطلب ورمز التحقق)
- الضغط على أيقونة (استعلام)

- توفر رقم طلب تنفيذ

- هذه الخدمة لا تتطلب تسجيل الدخول
...
تحميل دليل المستخدم](https://raqmi.dga.gov.sa/platformsAPI/api/attachments/ce249152-43e8-4a94-a233-b29000834c75)
...
تاريخ آخر تحديث لمحتوى الصفحة : 08/05/2025 بتمام الساعة 12:05 مساء بتوقيت المملكة العربية السعودية
