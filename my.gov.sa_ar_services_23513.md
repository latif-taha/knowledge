...
title: "التحقق من أهلية ساند | GOV.SA"
---
...
# التحقق من أهلية ساند

المؤسسة العامة للتأمينات الاجتماعية

الاكثر استخداما

خدمة إلكترونية تقدمها التأمينات الاجتماعية، بحيث تتيح للمستفيدين إمكانية التحقق من أهلية المشتركين السعوديين للاستفادة من نظام ساند من خلال إدخال أرقام هويتهم الوطنية دون الحاجة لمراجعة الجهة
...
[ابدأ الخدمة](https://www.gosi.gov.sa/ar/IndividualsServices/ServiceDetails/Check_eligibility_for_Snad)
...
- الدخول إلى الموقع الإلكتروني للمؤسسة العامة للتأمينات الاجتماعية أو التطبيق.
- الانتقال إلى قسم "الخدمات".
- اختيار "خدمات التحقق السريع".
- الضغط على أيقونة " أهلية ساند ".
- إدخال رقم السجل المدني ورمز التحقق.
- النقر على زر "تحقق".
...
تحميل دليل المستخدم](https://raqmi.dga.gov.sa/platformsAPI/api/attachments/b1c62aeb-62f0-4261-8057-b2bf0167d1b3)
