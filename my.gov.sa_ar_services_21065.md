---
url: "https://my.gov.sa/ar/services/21065"
title: "طلب اصدار ترخيص | GOV.SA"
---
...
خدمة الكترونية تتيح للمستفيدين تقديم طلبات لإصدار تراخيص لإنشاء أو تشغيل خطوط الأنابيب وشبكات الغاز وسوائله.
تهدف الخدمة إلى ضمان الامتثال للمعايير التنظيمية والفنية التي تضعها وزارة الطاقة، بما يدعم تطوير البنية التحتية لقطاع الطاقة وتعزيز كفاءتها التشغيلية في مختلف القطاعات

[اتفاقية مستوى الخدمة](https://www.moenergy.gov.sa/e-services/service-level-agreement?lang=ar)

تفضيل الصفحة![favorites_unflag](https://my.gov.sa/_next/static/media/icon_favorites_unFlag.5c963ba6.svg)

[ابدأ الخدمة](https://www.moenergy.gov.sa/e-services/new-takhsees-license?lang=ar)
...
- الدخول إلى البوابة الإلكترونية: تسجيل الدخول عبر بوابة وزارة الطاقة باستخدام النفاذ الوطني الموحد أو بيانات التسجيل.

- اختيار الخدمة: من قائمة الخدمات الإلكترونية، يتم اختيار خدمة” إصدار تراخيص خطوط الأنابيب وشبكات الغاز”.

- تعبئة الطلب: إدخال بيانات الجهة المستفيدة (مثل: اسم المنشأة، السجل التجاري، النشاط). إدخال جميع المعلومات اللازمة في نموذج الطلب.

-  إرفاق المستندات المطلوبة:رفع جميع الوثائق المطلوبة (مذكورة أدناه).
- مراجعة وتقديم الطلب:مراجعة البيانات والتأكد من صحتها، ثم تقديم الطلب.

- متابعة الطلب: يمكن للمستهلك متابعة حالة الطلب من خلال لوحة التحكم في الحساب.
- إصدار رخصة: عند الموافقة، يتم إصدار ترخيص خطوط الأنابيب وشبكات الغاز إلكترونيًا، ويمكن تحميله وطباعته.

- سجل تجاري قائم:

يجب أن تكون المنشأة التجارية مسجلة بشكل رسمي ومُعتمدة في المملكة.

- ترخيص من وزارة الاستثمار:

للمستثمر الأجنبي، يجب الحصول ترخيص من وزارة الإستثمار لمزاولة العمل التجاري داخل المملكة
...
[الأسئلة الشائعة\\
![أيقونة رابط خارجي](https://my.gov.sa/_next/static/media/icon_link_external.77151c29.svg)](https://www.moenergy.gov.sa/contact-us?lang=ar)
...
تاريخ آخر تحديث لمحتوى الصفحة : 06/05/2025 بتمام الساعة 01:05 مساء بتوقيت المملكة العربية السعودية
