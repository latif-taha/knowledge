---
url: "https://my.gov.sa/ar/services/18533"
title: "إدراج صفقة عقارية (نقل الملكية العقارية) | GOV.SA"
---
...
خدمة الكترونية تتيح للمستفيد إنشاء صفقة بين بائع ومشتري وإنهاء جميع التعاملات من خلال المنصة، وتتيح إمكانية الشراء بالتمويل أو إفراغ الصكوك المرهونة بعد موافقة الجهة الراهنة أو هبة العقار بشكل مباشر
...
[ابدأ الخدمة](https://www.moj.gov.sa/ar/eServices/Pages/ServiceDetailsNew.aspx?itemId=428)
...
- اختيار صفة المستفيد (وكالة \- شخصي)
-  النقر على القائمة أعلى يمين الصفحة
- النقر على أيقونة (خدمات التداول)
-  اختيار خدمة إدارج صفقة(صفقة خاصة ، هبة، دون مشتري محدد)
-  اختيار أحد العقارات المملوكة
- تعبئة بيانات وتفاصيل الصفقة
- تقديم الطلب

- حساب آيبان فعال مرتبط باسم المستفيد
-  وكالة سارية المفعول بالبنود العقارية في حال كان مقدم الطلب وكيلًا عن المستفيد
- وثيقة تملك عقار
- رقم مرجعي لضريبة التصرفات العقارية من هيئة الزكاة و الدخل

- يلـزم تسـجيل بيانـات الصفقـة فـي ضريبـة التصرفات العقارية لـدى هيئة الدخل والضريبة والجمـارك والحصـول علـى رقـم مرجعـي ولا يلـزم تسـديد المبلـغ
- النظام يسمح بإضافة أكثر من مشتري
...
تحميل دليل المستخدم](https://prod-srem-business-api-srem.moj.gov.sa/api/v1/Download/DownloadGuide)
